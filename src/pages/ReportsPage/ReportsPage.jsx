...
const ReportsPage = ({ startDate }) => {
  const [monthsDateReports, setmonthsDateReports] = useState(
    new Date(startDate)
  );
  ...
  const date = `${monthsDateReports.getFullYear()}-${
    monthsDateReports.getMonth() + 1
  }`;
  ...
  return (
    <div className={s.reportsContainer}>
      <div className={s.reportsNav}>
        ...
        <DateResults
          dateValue={monthsDateReports}
          setDateValue={setmonthsDateReports}
        />
